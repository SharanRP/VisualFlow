...
function MySideNav({ deleteNode , selectedNode , clearCanvas ,onSave , onRestore, nodes ,setNodes , edges , setEdges, nodeType}){
    ...
    const [arrayElemType, setArrayElemType] = useState('');
...
{
let codeString = `
${dataT} AddNumbers(const vector<${dataT}> &arr) {
  if (arr.empty()) {
...
const BinarySearch = () => {
  let codeString = `
${arrayElemType} bin_search (${arrayElemType} arr[], int num, ${arrayElemType} tgt)  
{  
int beg = 0, end = num - 1;    
while (beg <= end)  
{  
...
void selectionSort(${arrayElemType} arr[], int n)  
{  
int i, j, min_idx;  
...
void bubbleSort(${arrayElemType} arr[], int n) 
{ 
  int i, j; 
  for (i = 0; i < n - 1; i++) 
...
const outputContent = () => {
  ...
  //       <div class ="my-2">
  //         {inputs.map((input) => (
  //           <div key={input.id} class="grid grid-cols-3 gap-4 my-3">
  ...
  //           </div>
  //         ))}
  //         {/* <button onClick={addInput} className="mt-4 mb-2 bg-blue-600 text-white rounded-lg p-2 hover:bg-blue-800">
  ...
  //   }
   ...
   //       setArrayElem(Array(length).fill('')); // Initialize the array with empty strings
   //     };
   ...
   //       <div class ="border-gray-400 border-2 p-2 m-2" >
   //         <select
   ...
   //         <ul class = " h-40 overflow-auto ">{arrayInputComponents}</ul>
   //       </div>
   //     );
   //  }
...
function VectorInputComponent() {
  ...
  return (
    ...
    useEffect(() => {
      ...
      //    inptBx.innerHTML = `
      //    <label class ="my-2 p-2">Data Type :</label>
      //    <select id="nodeType" value="${dataType}" onChange="${setDataType}"  class="placeholder-opacity-50  placeholder-gray-500 bg-gray-800 border border-gray-300 text-gray-100 text-sm text-left rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 " >
      //    <option value="int" selected class="placeholder-gray-500" >Int</option>
      //    <option value="Float" >Float</option>
      //    <option value="Char" >Char</option>
      //    <option value="String" >String</option>
      //    </select>

      //    <label class="my-2 p-2">Value</label>
      //    <input type="text" id="inputnode-1" input-id ="1" value="${label}"  onChange="${handleLabelChange}"
      //    class="placeholder-gray-500 my-2 bg-gray-800 border-gray-300 text-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Input" required/>
       
      //    `
      //    console.log(setDataType);

      // }else if(selectInputType === "multi-input"){

      //    inptBx.innerHTML = 
      //    `
      //    <select id="nodeType" value={dataType} onChange{(e)=>{setDataType(e.target.value)}} class="placeholder-opacity-50  placeholder-gray-500 bg-gray-800 border border-gray-300 text-gray-100 text-sm text-left rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 " >
      //    <option value="int" selected class="placeholder-gray-500" >Int</option>
      //    <option value="Float" >Float</option>
      //    <option value="Char" >Char</option>
      //    <option value="String" >String</option>
      ...
      //    `
      //    console.log("Input for multi selected")
      ...
      //    `
      //    <label>No. of inputs</label>
      //    <input type="text" id="inputnode-1" input-id ="1" value="${arrayElemNo}"  onChange="${setArrayElemNo}"
      //    class="placeholder-gray-500 m-2 bg-gray-800 border-gray-300 text-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Input" required/>
         
      //    <label>No. of inputs</label>
      //    <input type="text" id="inputnode-1" input-id ="1" value="${arrayElem}"  onChange="${setArrayElem}"
      //    class="placeholder-gray-500 m-2 bg-gray-800 border-gray-300 text-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Input" required/>
...
const handleAddNodeClick = () => {
  ...
  else if(selectedNodeType === "decision")
  {
    ...
    const yesNodeId = `yesNode_${Date.now()}`;
    const noNodeId = `noNode_${Date.now()}`;
